...
urlpatterns = [
    ...
    path("<int:content_id>/favorite", views.ContentFavoriteAPIView.as_view(), name="content_favorite"),
    path("<int:content_id>/like", views.ContentLikeAPIView.as_view(), name="content_like"),
